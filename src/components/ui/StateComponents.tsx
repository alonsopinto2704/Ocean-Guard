...
export function LoadingState({
  ...
  return (
    <div role="status" aria-live="polite" className={cn('flex flex-col items-center justify-center gap-3', sizeMap[size], className)}>
      <Loader2 aria-hidden="true" className="w-8 h-8 text-cyan-500 animate-spin" />
...
export function EmptyState({
  ...
  return (
    <div role="alert" className={cn('flex flex-col items-center justify-center py-16 gap-4 text-center px-4', className)}>
      {icon && (
...
export function OfflineState({ className }: { className?: string }) {
  return (
    <div role="status" aria-live="polite" className={cn('flex flex-col items-center justify-center py-16 gap-4 text-center', className)}>
